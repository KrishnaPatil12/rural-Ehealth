...
<div class="form-container">
    <form action="Aviewv.jsp">
    <h2>View by Name</h2>
        <label>Enter name to view specific details:</label>
        <input type="text" name="name" placeholder="Name of Aarogya Vibhag">
...
<%
    ...
    try {
        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM aarogya WHERE name=?");
...
<%
        ...
        if (!found) {
%>
<tr><td colspan="6"><b>No matching record found.</b></td></tr>
<%
        }
    } catch (Exception e) {
        e.printStackTrace();
